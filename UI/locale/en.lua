local Translations = {
	...
	error = {
		...
		missing_community_id_console = '^1CONFIG ERROR: COMMUNITY ID NOT SET, THIS IS REQUIRED TO PREVENT CONFLICTS FOR PLAYERS WHO PLAY ON MULTIPLE SERVERS WITH LVC. ^3PLEASE SET THIS IN SETTINGS.LUA.',
		...
		resource_conflict_console = '^1LVC ERROR: DETECTED CONFLICTING RESOURCE, PLEASE VERIFY THAT "^3lux_vehcontrol^1", "^3lvc_fleet^1", OR "^3qb-extras^1" ARE NOT RUNNING.',
