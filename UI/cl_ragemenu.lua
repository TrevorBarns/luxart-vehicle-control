...
Citizen.CreateThread(function()
    while true do
		...
		RageUI.IsVisible(RMenu:Get('lvc', 'tkdsettings'), function()
			...
			RageUI.List('Integration', {"Off", "TKSs Set High-beams", "High-beams Set TKDs"}, tkd_mode, "Determines whether high-beams will auto toggle takedowns or visa versa.", {}, tkd_masterswitch, {
			  onListChange = function(Index, Item)
				tkd_mode = Index
			  end,
			})			
